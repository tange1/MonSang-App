      ...
      <div id="q-app">
        <div class="q-pa-md row items-start q-gutter-md">
          <q-card class="link-card">
            ...
            <q-card-section>
              <q-btn label="Antworten prüfen" class="full-width" color="primary" type="submit"
            ...
            <q-card-section>
               <q-btn label="Antworten zurücksetzen" class="full-width" color="info" type="button"
                @click="confirm = false"></q-btn>
            </q-card-section>


             <q-dialog :model-value="(confirm && question_1 == 'ja' && question_2 == 'ja' && question_3 == 'ja' && question_4 == 'ja' && question_5 == 'ja' && question_6 == 'ja' && question_7 == 'ja' && question_8 == 'ja' && question_9 == 'ja')" persistent>
              <q-card class="my-card">
                ...
                <q-card-actions align="around">
                  <q-btn flat label="Cancel" color="primary" v-close-popup @click="confirm = false" />
                </q-card-actions>
              </q-card>
            </q-dialog>


            <q-dialog :model-value="(confirm && (question_1 === 'nein' || question_2 === 'nein' || question_3 === 'nein' || question_4 === 'nein' || question_5 === 'nein' || question_6 === 'nein' || question_7 === 'nein' || question_8 === 'nein' || question_9 === 'nein'))" persistent>
              <q-card class="my-card">
                <q-card-section class="bg-secondary text-white">
                  <q-avatar size="lg" class="align-center" icon="error_outline" color="primary" text-color="white"></q-avatar>
                  <div class="text-h6">You are fine</div>
                </q-card-section>
                <q-card-actions align="around">
                  <q-btn flat label="Cancel" color="primary" v-close-popup @click="confirm = false" />
                </q-card-actions>
            ...
            <q-dialog :model-value="(confirm && question_1 === null && question_2 === null && question_3 === null && question_4 === null && question_5 === null && question_6 === null && question_7 === null && question_8 === null && question_9 === null)" persistent>
              <q-card class="my-card">
                <q-card-section class="bg-secondary text-white">
                  <q-avatar size="lg" class="align-center" icon="error_outline" color="primary" text-color="white"></q-avatar>
                  <div class="text-h6">Please select all button</div>
                </q-card-section>
                <q-card-actions align="around">
                  <q-btn flat label="Cancel" color="primary" v-close-popup @click="confirm = false" />
                </q-card-actions>
            ...
            <q-dialog :model-value="(confirm && question_1 == 'ja' && question_2 == 'ja' && question_3 == 'ja' && question_4 == 'ja' && question_5 == 'ja' && question_6 == 'ja' && question_7 == 'ja' && question_8 == 'ja' && question_9 == 'ja')" persistent>
              <q-card class="my-card">
                ...
                <q-card-actions align="around">
                  <q-btn flat @click="$router.push('/termin')">Weiter zum Termin</q-btn>
                  <q-btn flat v-close-popup>Abbrechen</q-btn>
                </q-card-actions>
              </q-card>
            </q-dialog>

            <q-dialog :model-value="(confirm && question_1 === 'ja' && question_2 === 'ja' && question_3 === 'nein')" persistent>
              <q-card class="my-card">
                <q-card-section class="bg-secondary text-white">
                  <q-avatar size="lg" class="align-center" icon="error_outline" color="primary"
                    text-color="white"></q-avatar>
